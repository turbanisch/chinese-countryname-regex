...
All output files are saved in `data/`. The regular expressions added manually to ISO3 codes are in `data-raw/regexes.csv`. `dict.csv` differs from this file by including additional columns (e.g., country name in English) to create a more comprehensive conversion table.
...
- `dict.csv`: Only ISO3 codes, country name in English and regular expressions. 
